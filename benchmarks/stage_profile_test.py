...
STAGE_TARGETS = [
    ...
    ('find_best_cost_brute_force', 'c) find_best_cost_brute_force [bonus]'),
    ('find_best_cost_brent', 'c) find_best_cost_brent [bonus]'),
    ('find_best_cost_analytical', 'c) find_best_cost_analytical [bonus]'),
